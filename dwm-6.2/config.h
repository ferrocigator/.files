...
#define VOLLOW	0x1008ff11
#define VOLTOG	0x1008ff12
...
static const char *vollow[]	= { "amixer", "set", "Master", "5%-", NULL };
static const char *voltog[]	= { "amixer", "set", "Master", "toggle", NULL };
static const char *liup[]	= { "light", "-A", "10", NULL };
static const char *lilow[]	= { "light", "-U", "10", NULL };
...
static Key keys[] = {
	...
	{ 0,                            VOLLOW,    spawn,          {.v = vollow } },
	{ 0,                            VOLTOG,    spawn,          {.v = voltog } },
	{ MODKEY,                       XK_F11,    spawn,          {.v = liup } },
	{ MODKEY,                       XK_F10,    spawn,          {.v = lilow } },
