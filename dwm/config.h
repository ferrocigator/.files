...
static const unsigned int gappx     = 10;        /* gap pixel between window */
static const unsigned int snap      = 32;       /* snap pixel */
static const int showbar            = 1;        /* 0 means no bar */
static const int topbar             = 1;        /* 0 means bottom bar */
static const char *fonts[]          = { "Roboto Mono:size=8", };
static const char dmenufont[]       = "Roboto Mono:size=8";
